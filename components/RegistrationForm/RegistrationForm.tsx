...
const RegistrationForm = () => {
  return (
    <div className="container__reg">
      ...
      <input className="inputForm" type="text" placeholder="Email"></input>
      <input className="inputForm" type="text" placeholder="Пароль"></input>
      <input className="inputForm" type="text" placeholder="Пароль еще раз"></input>
